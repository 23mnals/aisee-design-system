...
const assets = {
  ...
  'action-minus.svg': 'line_line_nochange.svg',
  ...
  'action-copy.svg': 'line_file_copy.svg',
  'action-add-customer.svg': 'line_people_add_contact.svg',
  'action-time-slots.svg': 'line_clock_time.svg',
  'action-disable.svg': 'line_prohibited_not_clickable.svg',
  'action-delete.svg': 'line_trash_delete.svg',
