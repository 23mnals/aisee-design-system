...
window.Icons = {
  ...
  TrendingUp: mk(<><path d="m22 7-8.5 8.5-5-5L2 17"/><path d="M16 7h6v6"/></>),
  ListChecks: mk(<><path d="M3 5h2l1 1 2-2M3 12h2l1 1 2-2M3 19h2l1 1 2-2"/><path d="M13 5h8M13 12h8M13 19h8"/></>),
  BarChart: mk(<><path d="M3 3v18h18"/><rect x="7" y="11" width="3" height="6"/><rect x="12" y="7" width="3" height="10"/><rect x="17" y="13" width="3" height="4"/></>),
  CornerUpLeft: mk(<><path d="M9 14 4 9l5-5"/><path d="M4 9h11a5 5 0 0 1 5 5v6"/></>),
  HelpCircle: mk(<><circle cx="12" cy="12" r="10"/><path d="M9.1 9a3 3 0 0 1 5.8 1c0 2-3 3-3 3"/><path d="M12 17h.01"/></>),
  Volume2: mk(<><path d="M11 5 6 9H2v6h4l5 4z"/><path d="M19 5a9 9 0 0 1 0 14M15.5 8.5a4 4 0 0 1 0 7"/></>),
