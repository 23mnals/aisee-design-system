...
Production delivery version: 0a45a3d79a8a62ad. Installer SHA-256: 5aeb4ce8e4da9ba70b1211b3d1c28de924c030333c137c137a5c570ec4c16f22
...
- selection-group: ToggleSelectionGroup.tsx. Required: independent group enablement and preserved item selections; accessible labels, disabled handling and keyboard activation. Fallback: standalone.
- checkbox: Checkbox.tsx. Required: checked, indeterminate and disabled state, form semantics; keyboard activation, focus and AISEE celebration state hooks. Fallback: standalone.
- switch: Toggle.tsx. Required: checked/defaultChecked, disabled and change callback; keyboard activation and state hooks for AISEE motion. Fallback: standalone.
...
1. Complete Host Project Compatibility inspection above, then download https://23mnals.github.io/aisee-design-system/assets/ai-deliveries/toggle-selection-group/releases/0a45a3d79a8a62ad/install.cjs as .aisee-install.cjs inside the host project; verify SHA-256 5aeb4ce8e4da9ba70b1211b3d1c28de924c030333c137c137a5c570ec4c16f22 before execution. Do not print archive data into chat.
2. Run `node .aisee-install.cjs src/components/aisee/toggle-selection-group` (adapt the path). It unpacks exactly the production list; it installs no npm packages and refuses different existing files. Inspect conflicts or choose a new directory; never erase previous integrations automatically.
