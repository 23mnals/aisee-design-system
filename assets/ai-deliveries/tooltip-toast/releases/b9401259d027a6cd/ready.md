...
Production delivery version: b9401259d027a6cd. Installer SHA-256: e625b15ba75c8824d7fab94f039f1f69c31f21c2eae2a04a19dee02669c1eba8
...
- tooltip: Tooltip.tsx. Required: hover/focus open, Escape dismiss and trigger ref; portal and collision-aware automatic placement with scroll/resize tracking; AISEE spring pointer tracking, directional entrance and separate positioning/motion transforms. Fallback: standalone.
- live-region: Toast.tsx. Required: status/alert semantics, accessible dismissal and lifecycle cleanup; AISEE timer/progress and entry/exit motion hooks. Fallback: standalone.
...
1. Complete Host Project Compatibility inspection above, then download https://23mnals.github.io/aisee-design-system/assets/ai-deliveries/tooltip-toast/releases/b9401259d027a6cd/install.cjs as .aisee-install.cjs inside the host project; verify SHA-256 e625b15ba75c8824d7fab94f039f1f69c31f21c2eae2a04a19dee02669c1eba8 before execution. Do not print archive data into chat.
2. Run `node .aisee-install.cjs src/components/aisee/tooltip-toast` (adapt the path). It unpacks exactly the production list; it installs no npm packages and refuses different existing files. Inspect conflicts or choose a new directory; never erase previous integrations automatically.
