# Integrate AISEE EmptyState

Production delivery version: c94b24aa8f1ca43d. Installer SHA-256: 38d6996a095c59033d0ad07adf41c1fc54dfe910a3d913030553ef1996cdddd1
...
- styles.css
- assets/empty-state/library/bound.svg
- assets/empty-state/library/free-use.svg
- assets/empty-state/library/link.svg
- assets/empty-state/library/no-account.svg
- assets/empty-state/library/no-credit.svg
- assets/empty-state/library/no-event.svg
- assets/empty-state/library/no-media.svg
- assets/empty-state/library/no-report-data.svg
- assets/empty-state/library/no-report.svg
- assets/empty-state/library/no-time-slot.svg
- assets/empty-state/library/nobody.svg
- assets/empty-state/library/nothing.svg
- assets/empty-state/library/plugin.svg
- assets/empty-state/library/unlock.svg
- index.ts
- styles.css.d.ts
- assets/empty-state/library/bound.svg.d.ts
- assets/empty-state/library/free-use.svg.d.ts
- assets/empty-state/library/link.svg.d.ts
- assets/empty-state/library/no-account.svg.d.ts
- assets/empty-state/library/no-credit.svg.d.ts
- assets/empty-state/library/no-event.svg.d.ts
- assets/empty-state/library/no-media.svg.d.ts
- assets/empty-state/library/no-report-data.svg.d.ts
- assets/empty-state/library/no-report.svg.d.ts
- assets/empty-state/library/no-time-slot.svg.d.ts
- assets/empty-state/library/nobody.svg.d.ts
- assets/empty-state/library/nothing.svg.d.ts
- assets/empty-state/library/plugin.svg.d.ts
...
1. Complete Host Project Compatibility inspection and identify a requested missing capability first. If nothing is missing, make no changes. Only if reference source is needed, download https://23mnals.github.io/aisee-design-system/assets/ai-deliveries/empty-state/releases/c94b24aa8f1ca43d/install.cjs as .aisee-install.cjs inside the host project; verify SHA-256 38d6996a095c59033d0ad07adf41c1fc54dfe910a3d913030553ef1996cdddd1 before execution. Do not print archive data into chat.
2. If the target component or styles already exist, run `node .aisee-install.cjs .aisee-reference/empty-state` only to inspect the verified source, extract only the requested missing capability into the existing host path while preserving its styles, library and interactions; for animation requests add only missing motion, and remove .aisee-reference afterwards. Do not create src/components/aisee or a second components/ui tree.
3. Only when the target component is absent and no host primitive provides the needed capability, run `node .aisee-install.cjs src/components/aisee/empty-state` (adapt the path) as a new standalone boundary following the host styling conventions. Never use this fallback to replace an existing target. The installer writes exactly the production list, installs no npm packages and refuses different existing files.
