...
Production delivery version: 0b91c38f8fbe3c28. Installer SHA-256: 8d302f2bee70397e8fdd1e666d338218a245b3a444f2c0bff6068c37d5dcc5e6
...
- portal: SidebarNavigation.tsx. Required: explicit portal target and host stacking context; toggle ownership, focus, Escape and hover reveal coordination. Fallback: standalone.
...
1. Complete Host Project Compatibility inspection above, then download https://23mnals.github.io/aisee-design-system/assets/ai-deliveries/sidebar-navigation/releases/0b91c38f8fbe3c28/install.cjs as .aisee-install.cjs inside the host project; verify SHA-256 8d302f2bee70397e8fdd1e666d338218a245b3a444f2c0bff6068c37d5dcc5e6 before execution. Do not print archive data into chat.
2. Run `node .aisee-install.cjs src/components/aisee/sidebar-navigation` (adapt the path). It unpacks exactly the production list; it installs no npm packages and refuses different existing files. Inspect conflicts or choose a new directory; never erase previous integrations automatically.
