# Integrate AISEE Tabs

Production delivery version: 977a720318955ae5. Installer SHA-256: 670032f51e6943d9d83fc0b92221ef601879d85ce5c9bd4ecceee3ad10ea95cb
...
- tabs: Tabs.tsx. Reference capabilities (only the requested missing subset applies to an existing target): controlled value and change callback, disabled tabs and keyboard navigation; AISEE state classes, measurement refs and label visibility. Fallback for an absent target only: standalone.
...
- Preserve controlled selection, keyboard navigation, icon/text variants and responsive platform labels.
