...
Production delivery version: afadd8247927950c. Installer SHA-256: d0ed29fdd05475be04ea5011f1e03bc0e74c4fb707be0b6b9a45602fd0f11816
...
- single-choice: SegmentedChoice.tsx. Required: controlled selection, disabled choices and keyboard activation; AISEE option layout and selected/focus hooks. Fallback: standalone.
...
1. Complete Host Project Compatibility inspection above, then download https://23mnals.github.io/aisee-design-system/assets/ai-deliveries/segmented-choice/releases/afadd8247927950c/install.cjs as .aisee-install.cjs inside the host project; verify SHA-256 d0ed29fdd05475be04ea5011f1e03bc0e74c4fb707be0b6b9a45602fd0f11816 before execution. Do not print archive data into chat.
2. Run `node .aisee-install.cjs src/components/aisee/segmented-choice` (adapt the path). It unpacks exactly the production list; it installs no npm packages and refuses different existing files. Inspect conflicts or choose a new directory; never erase previous integrations automatically.
