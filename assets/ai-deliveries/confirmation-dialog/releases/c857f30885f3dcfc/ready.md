...
Production delivery version: c857f30885f3dcfc. Installer SHA-256: d84206e6ddd07e2fa6b55025ea85dfe04c46c92b7ff112030b1c4623eb2ab69e
...
- dialog: ConfirmationDialog.tsx. Required: controlled open, cancel-first focus, focus return and modal isolation; Escape/cancel handling, accessible title/description and native dialog ref API; AISEE impact notices, confirm-disabled behavior and host-owned callbacks. Fallback: standalone.
- button: Button.tsx. Required: native button semantics, disabled/type and keyboard activation; forwarded button ref and AISEE className, icon slots and hover/focus hooks. Fallback: standalone.
