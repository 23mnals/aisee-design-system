...
Production delivery version: 347ecf1cf4040ad3. Installer SHA-256: 06f048932240442be782fab5f12f4cbac3b35a9ae30294da89131137a3d4ff93
...
- button: NotificationBell.tsx. Required: native button props, accessible label, pointer/focus and click callbacks; AISEE inner glyph motion and badge state driven by real count; outer button stays fixed. Fallback: standalone.
...
1. Complete Host Project Compatibility inspection above, then download https://23mnals.github.io/aisee-design-system/assets/ai-deliveries/notification-bell/releases/347ecf1cf4040ad3/install.cjs as .aisee-install.cjs inside the host project; verify SHA-256 06f048932240442be782fab5f12f4cbac3b35a9ae30294da89131137a3d4ff93 before execution. Do not print archive data into chat.
2. Run `node .aisee-install.cjs src/components/aisee/notification-bell` (adapt the path). It unpacks exactly the production list; it installs no npm packages and refuses different existing files. Inspect conflicts or choose a new directory; never erase previous integrations automatically.
