...
Production delivery version: 1540c33f6b92f350. Installer SHA-256: 9167abf98a5627ecb022d7a19160b76b40354c52bb3d594b65b43531cf2abb0d
...
- popover: Dropdown.tsx. Required: controlled visibility, outside dismissal and focus return; anchored collision-aware positioning, scroll/resize handling and portal className. Fallback: standalone.
- selection: Dropdown.tsx. Required: single/multiple selection, editable/filterable input and keyboard navigation; disabled/grouped items and nested row actions without selection conflicts. Fallback: standalone.
...
1. Complete Host Project Compatibility inspection above, then download https://23mnals.github.io/aisee-design-system/assets/ai-deliveries/dropdown/releases/1540c33f6b92f350/install.cjs as .aisee-install.cjs inside the host project; verify SHA-256 9167abf98a5627ecb022d7a19160b76b40354c52bb3d594b65b43531cf2abb0d before execution. Do not print archive data into chat.
2. Run `node .aisee-install.cjs src/components/aisee/dropdown` (adapt the path). It unpacks exactly the production list; it installs no npm packages and refuses different existing files. Inspect conflicts or choose a new directory; never erase previous integrations automatically.
